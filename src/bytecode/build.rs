...
use crate::{
    bytecode::{bytecode::Bytecode, order::compute_block_order},
    cfg::{
        cfg::{CFG, CFGEdge, CFGExpr, CFGOp, CFGValue},
        range::OffsetRange,
    },
};
...
pub fn build_bytecode(
    cfg: &CFG,
    offset_ranges: &HashMap<usize, OffsetRange>,
) -> Result<(Vec<Bytecode>, HashMap<usize, usize>), TryFromIntError> {
